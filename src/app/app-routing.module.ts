...
const routes: Routes = [
  ...
  {path: 'editar-aeropuerto/:id', component: AirportEditComponent},
  ...
  {path: 'editar-piloto/:id', component: PilotEditComponent},
  {path: 'crear-vuelo', component: FlightNewComponent},
  {path: 'gestionar-vuelo', component: FlightDetailComponent},
  {path: 'editar-vuelo/:id', component: FlightEditComponent},
  ...
  {path: 'editar-catalogoVuelo/:id', component: FlightCatalogEditComponent},
